...
import Upload from 'admin/components/Upload/singleImage3'
import MDinput from 'admin/components/MDinput'
import Multiselect from 'vue-multiselect'// 使用的一个多选框组件，element-ui的select不能满足所有需求
import 'vue-multiselect/dist/vue-multiselect.min.css'// 多选框组件css
import Sticky from 'admin/components/Sticky' // 粘性header组件
import { validateURL } from 'admin/utils/validate'
import { fetchArticle } from 'admin/api/article'
import { userSearch } from 'admin/api/remoteSearch'
