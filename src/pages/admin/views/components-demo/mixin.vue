...
<script>
import PanThumb from 'admin/components/PanThumb'
import MdInput from 'admin/components/MDinput'
import Mallki from 'admin/components/TextHoverEffect/Mallki'
import DropdownMenu from 'admin/components/Share/dropdownMenu'
import waves from 'admin/directive/waves/index.js' // 水波纹指令
